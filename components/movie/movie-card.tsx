...
export const MovieCard = ({ movie }: { movie: Movie }) => {
  ...
  return (
    <Link href={`/movie/${movie.id}`} className="group relative">
      <div className="flex flex-col gap-6 py-6 rounded-xl border shadow-sm transition-all hover:shadow-lg h-full">
        <div className="relative">
          <Image
            ...
            height={300}
            loading="eager"
            className="w-full object-cover rounded-md md:h-[330px]"
          />
          <button
